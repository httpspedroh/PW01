...
public class Inverted {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            for(int i = 0; i < Order.getTotalAccounts(); ++i) {
                ...
                Pair<String, Long> p = getBaIndexOf(i);
                ...
                if(hst.get(p.first) == null) hst.put(p.first, tmp);
                else {
            ...
            for(var x : hst.keySet()) {
                ...
                for(var y : hst.get(x)) System.out.print(y + " ");
    ...
    public static Pair<String, Long> getBaIndexOf(int index) throws IOException {
